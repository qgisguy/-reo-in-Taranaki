...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [19289947.964888, -4850788.051018, 19561199.545027, -4688941.745379], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([19289947.964888, -4850788.051018, 19561199.545027, -4688941.745379], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Percentage of Maori language speakers in Taranaki (by Statistical Area 1)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (884 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is an interactive web map which shows the percentage of Maori language speakers, compared to those who do not speak the language, in each Statistical Area (SA). Hover to highlight an area and click to activate a pop-up window that provides more information - ie SA name and the percentage of Moari language speakers in that SA. Note that SAs are not the same as suburbs, although many will take their name from a nearby suburb. Also, often a suburb will be split into several SAs with the same or similar names (eg Waitara West x2 and Waitara East). <br /><br />Note that the entire layer can be turned on and off via the legend. This allows you to zoom into an area of interest and then untick the layer to explore the base map underneath. <br /><br />Data source: Aotearoa Data Explorer • Totals by topic for individuals, (RC, TALB, UR, SA3, SA2, Ward, Health), 2013, 2018, and 2023 Censuses<br />     ';
            }
